...
const collectionsConfig = [
  {
    ...
    attributes: [
      ...
      { key: 'youtube_url1', type: 'string', size: 2000, required: false },
      { key: 'youtube_url2', type: 'string', size: 2000, required: false },
      { key: 'youtube_url3', type: 'string', size: 2000, required: false },
